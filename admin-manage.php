                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="#"><i class="icon-envelope-alt"></i> Mesaj</a></li>
                            <li><a href="lib/logout.php"><i class="icon-key"></i> Çıkış</a></li>
                        </ul>
                    </li>
              ...
              <div class="row">
					  ...
					  <section class="panel">
						  <div class="panel-body">
							  <div class="task-thumb-details">
								  <h1>Generatorleri Yönet</h1>
							  </div>
							  <legend></legend>
							  <div id="collapse">
								<button class="btn btn-info btn-block" data-toggle="collapse" data-target=".addgenerator" data-parent="#collapse"><i class="icon-plus"></i> Üretim Ekle</button></br>
								<form action="admin-manage.php" method="POST">
									<div class="addgenerator sublinks collapse">
										<legend></legend>
										<input name="addgenerator" type="text" class="form-control" placeholder="Örn. Netflix"></br>
										<button type="submit" class="btn btn-primary btn-block"><i class="icon-plus"></i> Üretim Ekle</button></br>
									</div>
								</form>
							  </div>
							  <legend></legend>
				  ...
				  <div class="col-lg-4">
					  <section class="panel">
						  <div class="panel-body">
							  <div class="task-thumb-details">
								  <h1>Paketleri Yönet</h1>
							  </div>
							  <legend></legend>
							  <div id="collapse">
								<button class="btn btn-info btn-block" data-toggle="collapse" data-target=".addpackage" data-parent="#collapse"><i class="icon-plus"></i> Paket Ekle</button></br>
								<form action="admin-manage.php" method="POST">
									<div class="addpackage sublinks collapse">
										...
										<select name="generator" class="form-control">
											<option value="" selected>Tüm üretimler</option>
											<?php
												$accountsquery = mysqli_query($con, "SELECT * FROM `generators`") or die(mysqli_error($con));
												while($row = mysqli_fetch_assoc($accountsquery)){
										...
										<select name="length" class="form-control">
											<option value="Lifetime" selected>Ömürboyu</option>
											<option value="1 Day">1 Gün</option>
											<option value="3 Days">3 Gün</option>
											<option value="1 Week">1 Gün</option>
											<option value="1 Month">1 Gün</option>
											<option value="2 Months">2 Ay</option>
											<option value="3 Months">3 Ay</option>
											<option value="4 Months">4 Ay</option>
											<option value="5 Months">5 Ay</option>
											<option value="6 Months">6 Ay</option>
											<option value="7 Months">7 Ay</option>
											<option value="8 Months">8 Ay</option>
											<option value="9 Months">9 Ay</option>
											<option value="10 Months">10 Ay</option>
											<option value="11 Months">11 Ay</option>
										...
										<button type="submit" class="btn btn-primary btn-block"><i class="icon-plus"></i> Paket Ekle</button></br>
									</div>
								</form>
							  </div>
							  <legend></legend>
			  ...
			  <div class="modal-dialog modal-sm">
				  <div class="modal-content">
					  <div class="modal-header">
						  ...
						  <h4 class="modal-title">Üretimi düzenle</h4>
					  </div>
		  ...
		  <div class="modal fade" id="editpackage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-sm">
				  <div class="modal-content">
					  <div class="modal-header">
						  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						  <h4 class="modal-title">Paketi Düzenle</h4>
					  </div>
					  <div class="modal-body">
					   <form action="admin-manage.php" method="POST">
						...
						<div class="form-group">
							<label>Üretim(s)</label>
							<select name="editgenerator" class="form-control">
								<option value="">Tüm Üretimler</option>
								<?php
									$accountsquery = mysqli_query($con, "SELECT * FROM `generators`") or die(mysqli_error($con));
									while($row = mysqli_fetch_assoc($accountsquery)){
										echo '<option value="'.$row[id].'">'.$row[name].'</option>';
						...
						<div class="form-group">
							...
							<select name="editlength" class="form-control">
								<option value="Lifetime">Ömürboyu</option>
								<option value="1 Day">1 Gün</option>
								<option value="3 Days">3 Gün</option>
