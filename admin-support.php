              ...
              <div class="row">
				  ...
				  <div class="col-lg-3">
					  <section class="panel">
						  <div class="panel-body">
							  <div class="task-thumb-details">
								  <h1>Destek İstatislikleri</h1>
							  </div>
							  <legend></legend>
								<ul class="nav nav-pills nav-stacked">
                                  <li><a href="#"> <strong><i class="icon-envelope"></i></strong>&nbsp Toplam İleti<span class="label label-primary pull-right r-activity"><?php echo $totaltickets;?></span></a></li>
                                  <li><a href="#"> <strong><i class="icon-download"></i></strong>&nbsp Alınan İleti<span class="label label-warning pull-right r-activity"><?php echo $receivedtickets;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-upload"></i></strong>&nbsp Gönderilen İleti<span class="label label-success pull-right r-activity"><?php echo $senttickets;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-remove"></i></strong>&nbsp Cevaplanan İleti<span class="label label-info pull-right r-activity"><?php echo $unansweredtickets;?></span></a></li>
								</ul></br>
								<legend></legend>
								<center><font size="3"><strong><i class="icon-upload"></i></strong>&nbsp Yanıt Durumu</font></center></br>
								<div class="progress progress-striped active progress-sm">
                                  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo $replystatus;?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $replystatus;?>%">
                                      <span class="sr-only"><?php echo $replystatus;?>% Tamamlanmış</span>
                                  </div>
                                </div>
						  </div>
					  </section>
