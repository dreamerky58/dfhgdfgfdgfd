...
<html lang="en">
  <head>
    ...
    <title><?php echo $website;?> - Destek</title>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="lib/logout.php"><i class="icon-key"></i> Çıkış Yap</a></li>
                        </ul>
                    </li>
                      ...
                      <section class="panel">
                          <div class="panel-body">
							  ...
							  <form method="POST"/>
								...
								<button class="btn btn-info btn-large btn-block">Gönder</button>
							  </form>
                          </div>
					  </section>
                  </div>
