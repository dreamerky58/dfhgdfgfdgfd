              ...
              <div class="row">
								  ...
								  <table class="table table-striped table-advance table-hover">
									...
									<div id="collapse">
									  ...
									  <tr>
										  ...
										  <th><i class="icon-repeat"></i> Toplam Üretilen</th>
										  <th><i class="icon-calendar"></i> Bugün Üretilen</th>
										  <th></th>
									  </tr>
									  </thead>
				  ...
				  <div class="col-lg-3">
					  <section class="panel">
						  <div class="panel-body">
							  <div class="task-thumb-details">
								  <h1>Üretim İstatislikleri</h1>
							  </div>
							  <legend></legend>
								<ul class="nav nav-pills nav-stacked">
                                  <li><a href="#"> <strong><i class="icon-repeat"></i></strong>&nbsp Toplam Üretilen<span class="label label-primary pull-right r-activity"><?php echo $generated;?></span></a></li>
                                  <li><a href="#"> <strong><i class="icon-calendar"></i></strong>&nbsp Bugün Üretilen<span class="label label-warning pull-right r-activity"><?php echo $generatedtoday;?></span></a></li></br>
								  <legend></legend>
								  <a class="btn btn-danger btn-block" href="admin-statistics.php?action=resetall"><i class="icon-remove-circle "> Hepsini Sıfırla</i></a>
								</ul>
						  </div>
					  </section>
				  </div>
