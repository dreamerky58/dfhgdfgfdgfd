                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="#"><i class="icon-envelope-alt"></i> Mesajlar</a></li>
              ...
              <div class="row">
									...
									<div id="collapse">
										...
										<div id="addsubscription" class="sublinks collapse">
											...
											<form action="admin-subscriptions.php" method="POST">
												...
												<button type="submit" class="btn btn-primary btn-large btn-block"><i class="icon-plus"></i> Abonelik Ekle</button>
											</form>
										</div>
										<legend></legend>
									  ...
									  <tr>
										  ...
										  <th><i class="icon-tag"></i> Paket</th>
										  <th><i class="icon-calendar"></i> Sona Erme</th>
										  <th></th>
										  <th></th>
									  </tr>
									  </thead>
				  ...
				  <div class="col-lg-3">
					  <section class="panel">
						  <div class="panel-body">
							  <div class="task-thumb-details">
								  <h1>Abonelik İstatislikleri</h1>
							  </div>
							  <legend></legend>
								<ul class="nav nav-pills nav-stacked">
                                  <li><a href="#"> <strong><i class="icon-tags"></i></strong>&nbsp Toplam Abonelik<span class="label label-primary pull-right r-activity"><?php echo $totalsubscriptions;?></span></a></li>
                                  <li><a href="#"> <strong><i class="icon-ok"></i></strong>&nbsp Aktif Abonelik<span class="label label-warning pull-right r-activity"><?php echo $activesubscriptions;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-remove"></i></strong>&nbsp Biten Abonelik<span class="label label-success pull-right r-activity"><?php echo $expiredsubscriptions;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-calendar"></i></strong>&nbsp Bugünün Abonelikleri<span class="label label-info pull-right r-activity"><?php echo $todayssubscriptions;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-off"></i></strong>&nbsp İptal Olan Abonelikler<span class="label label-default pull-right r-activity"><?php echo $canceledsubscriptions;?></span></a></li>
								</ul>
						  </div>
					  </section>
				  </div>
			  ...
			  <div class="modal-dialog modal-sm">
				  <div class="modal-content">
					  <div class="modal-header">
						  ...
						  <h4 class="modal-title">Abonelik Bilgisi</h4>
					  </div>
					  <div class="modal-body">
						...
						<div class="form-group">
						  <label for="expires">Sona Erme</label>
		  ...
		  <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div class="modal-dialog modal-sm">
				  <div class="modal-content">
					  <div class="modal-header">
						  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						  <h4 class="modal-title">Abonelikleri Düzenle</h4>
					  </div>
					  <div class="modal-body">
					   <form action="admin-subscriptions.php" method="POST">
