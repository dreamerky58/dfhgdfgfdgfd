									...
									<div id="collapse">
										...
										<div id="adduser" class="sublinks collapse">
											...
											<form action="admin-users.php" method="POST">
												...
												<button type="submit" class="btn btn-primary btn-large btn-block"><i class="icon-plus"></i> Kullanıcı Ekle</button>
											</form>
										</div>
										<legend></legend>
									  ...
									  <tr>
										  ...
										  <th><i class="icon-star"></i> Statü</th>
										  <th></th>
										  <th></th>
										  <th></th>
									  </tr>
						  ...
						  <div class="panel-body">
							  ...
							  <legend></legend>
								<ul class="nav nav-pills nav-stacked">
                                  <li><a href="#"> <strong><i class="icon-user"></i></strong>&nbsp Toplam Kullanıcı<span class="label label-primary pull-right r-activity"><?php echo $totalusers;?></span></a></li>
                                  <li><a href="#"> <strong><i class="icon-ok"></i></strong>&nbsp Aktif Kullanıcı<span class="label label-warning pull-right r-activity"><?php echo $activeusers;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-remove"></i></strong>&nbsp Yasaklanan Kullanıcı<span class="label label-success pull-right r-activity"><?php echo $bannedusers;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-calendar"></i></strong>&nbsp Bugünün Kullanıcıları<span class="label label-info pull-right r-activity"><?php echo $todaysusers;?></span></a></li>
								</ul>
						  </div>
					  </section>
				  </div>
			  ...
			  <div class="modal-dialog modal-sm">
				  <div class="modal-content">
					  <div class="modal-header">
						  ...
						  <h4 class="modal-title">Kullanıcı Bilgisi</h4>
					  </div>
