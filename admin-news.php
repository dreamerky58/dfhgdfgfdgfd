              ...
              <div class="row">
						  ...
						  <div class="panel-body">
							  ...
							  <legend></legend>
								<form action="admin-news.php" method="POST">
									...
									<button type="submit" class="btn btn-info btn-block">Yeni Haber Ekle</button></br>
								</form>
								<legend></legend>
								<?php
				  ...
				  <div class="col-lg-3">
					  <section class="panel">
						  <div class="panel-body">
							  <div class="task-thumb-details">
								  <h1>Yeni İstatislikler</h1>
							  </div>
							  <legend></legend>
								<ul class="nav nav-pills nav-stacked">
                                  <li><a href="#"> <strong><i class="icon-bell"></i></strong>&nbsp Toplam Yeni Mesaj<span class="label label-primary pull-right r-activity"><?php echo $totalnews;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-calendar"></i></strong>&nbsp Bugün Yeni Mesaj<span class="label label-warning pull-right r-activity"><?php echo $todaysnews;?></span></a></li></br>
								  <legend></legend>
								</ul>
						  </div>
					  </section>
						  ...
						  <div class="modal-dialog modal-sm">
							  <div class="modal-content">
								  <div class="modal-header">
									  ...
									  <h4 class="modal-title">Yeni Mesajları Düzenle</h4>
								  </div>
