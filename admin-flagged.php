								...
								<section class="panel">
								  <table class="table table-striped table-advance table-hover">
									...
									<div id="collapse">
									  ...
									  <thead>
									  <tr>
										  <th><i class="icon-repeat"></i> Üretme</th>
						  ...
						  <div class="panel-body">
							  ...
							  <legend></legend>
								<ul class="nav nav-pills nav-stacked">
                                  <li><a href="#"> <strong><i class="icon-lock"></i></strong>&nbsp Toplam Alts<span class="label label-primary pull-right r-activity"><?php echo $totalalts;?></span></a></li>
                                  <li><a href="#"> <strong><i class="icon-flag"></i></strong>&nbsp İşaretli Alts<span class="label label-warning pull-right r-activity"><?php echo $flaggedalts;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-ok"></i></strong>&nbsp Aktif Alts<span class="label label-success pull-right r-activity"><?php echo $activealts;?></span></a></li>
								  <li><a href="#"> <strong><i class="icon-remove"></i></strong>&nbsp Pasif Alts<span class="label label-danger pull-right r-activity"><?php echo $disabledalts;?></span></a></li>
								</ul>
						  </div>
					  </section>
				  </div>
